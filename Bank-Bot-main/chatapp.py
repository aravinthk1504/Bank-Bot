...
#Create Chat window
ChatLog = Text(base, bd=0, bg="white", height="8", width="250", font=("times new roman",12),wrap='word')
ChatLog.config(state=DISABLED)
...
EntryBox = Text(base, bd=0, bg="white",width="29", height="5", font=("times new roman",12),wrap='word')
